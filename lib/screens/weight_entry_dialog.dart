          ...
          body: new ListView(
            children: [
              ...
              Row(
                ...
                onChanged:(value) => viewModel.onEntryChanged(viewModel.weightEntry..weight = value),
                ...
                initialValue: viewModel.weightToDisplay,
              ),
              Text(""+viewModel.unit)
                ],
              ),
              ...
              // ),
              new ListTile(
                leading: new Icon(Icons.short_text, color: Colors.grey[500]),
                title: new TextField(
                    autocorrect: true,
                    maxLines: 3,
                    maxLength: 100,
