...
import '../widgets/progress_chart_dropdown.dart';
import '../widgets/progress_chart_utils.dart' as utils;
import '../widgets/progress_chart_utils.dart';
...
class ChartPainter extends CustomPainter {
  ...
  ui.Paragraph _buildParagraphForBottomLabel(int daysFromStart) {
    ui.ParagraphBuilder builder = new ui.ParagraphBuilder(
      ...
      ..pushStyle(new ui.TextStyle(color: Colors.grey[500]))
  ...
  _drawParagraphInsteadOfChart(ui.Canvas canvas, ui.Size size, String text) {
    ...
    ui.ParagraphBuilder builder = new ui.ParagraphBuilder(
      ...
      ..pushStyle(new ui.TextStyle(color:Colors.grey))
      ..addText(text);
    final ui.Paragraph paragraph = builder.build()
