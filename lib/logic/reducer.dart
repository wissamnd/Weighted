...
import 'States/mainpage_state.dart';
import 'States/firebase_state.dart';
import 'States/weightEntryDialog_state.dart';
import 'States/removedEntry_state.dart';
...
ReduxState reduce(ReduxState state, action) {
  ...
  double target = _reduceTarget(state,action);
...
double _reduceTarget(ReduxState reduxState, action) {
  double target = reduxState.target;
  if (action is OnTargetChangedAction) {
